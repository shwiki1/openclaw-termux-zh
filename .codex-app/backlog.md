...
- Promote the native Codex pager only after device smoke and branch/signing decisions; any fresh cloud build must use a logical build greater than `187`.
...
- Source metadata remains `2.5.0+143`; the latest published GitHub Release is `CiYuanXia-v5.4-173-arm64-v8a.apk` (Actions `29538124523`). Latest GitHub artifact candidate is `CiYuanXia-v6.8-187-arm64-v8a.apk` (Actions `29647690716`, artifact ID `8430713820`, digest `sha256:189c6eaaee4c0af6d48c54bacc0bfbeb13fcbfbba1af7ec644426a99f42f6abc`), but Gitee delivery failed. Latest fully Gitee-delivered candidate remains `CiYuanXia-v6.6-185-arm64-v8a.apk` (Actions `29640675284`, artifact ID `8428690154`, user already downloaded/installed it).
- The next fresh cloud build must use a new logical build greater than `187`; do not reuse withdrawn builds `154` or `155`, failed/reserved build `186`, GitHub-artifact candidate build `187`, or any other failed/reserved historical build numbers.

...
- On the terminal screen, keyboard open/close should use the route-scoped Android `adjustPan` path with `resizeToAvoidBottomInset: false`; avoid UI changes that force the native terminal and browser platform views to relayout during IME transitions.

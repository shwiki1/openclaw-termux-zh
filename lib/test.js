...
async function runTests() {
  ...
  test('Android host exposes the native terminal pager and native browser action bridge', () => {
    ...
    assert.ok(nativeBrowserView.includes('setCompoundDrawablesWithIntrinsicBounds(tintedIcon(iconRes), null, null, null)'));
    ...
    assert.ok(nativeBrowserView.includes('normalized.contains("让") || normalized.contains("Codex") -> R.drawable.lucide_square_pen'));

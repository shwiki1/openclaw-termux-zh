...
export function setupProotUbuntu() {
  ...
  const setupScript = `
    ...
    curl -fL --retry 3 -o node.tar.xz https://npmmirror.com/mirrors/node/v24.14.1/node-v24.14.1-linux-arm64.tar.xz || curl -fL --retry 3 -o node.tar.xz https://mirrors.ustc.edu.cn/node/v24.14.1/node-v24.14.1-linux-arm64.tar.xz
    tar -xJf node.tar.xz
    cp -a node-v24.14.1-linux-arm64/{bin,include,lib,share} /usr/local/

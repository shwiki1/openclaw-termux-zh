  ...
  group('UpdateResult.preferredApkAssetForArch', () {
    ...
    test('prefers exact arm asset for arm devices', () {
      expect(
        ...
        'CiYuanXia-v2.5-armeabi-v7a.apk',
      );
    });

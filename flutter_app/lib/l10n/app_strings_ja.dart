const Map<String, String> appStringsJa = {
  ...
  'customProviderFetchModelsAction': 'モデル取得',
  'customProviderFetchingModelsAction': '取得中...',
  'customProviderFetchModelsFailed': 'モデル取得に失敗しました: {error}',
  'customProviderSelectModelTitle': 'モデルを選択',
  'customProviderFetchedModelsHint': '{count} 件のモデルを取得しました。タップして入力します。',
  ...
  'customProviderTestModelsFound': '{count} 件のモデルを取得',
  ...
  'setupWizardIntroIdle':
      'Ubuntu 24.04.3、Node.js 24.15.0（arm64/x86_64、armv7 は 22.22.3）、最新安定版 OpenClaw を自己完結型の環境にダウンロードします。',

const Map<String, String> appStringsZhHans = {
  ...
  'customProviderFetchModelsFailed': '获取模型失败：{error}',
  'customProviderSelectModelTitle': '选择模型',
  'customProviderFetchedModelsHint': '已获取 {count} 个模型，可点击选择',
  ...
  'customProviderTestModelsFound': '获取到 {count} 个模型',
  ...
  'setupWizardIntroIdle':
      '这会将 Ubuntu 24.04.3、Node.js 24.15.0（arm64/x86_64，armv7 使用 22.22.3）和 OpenClaw 最新稳定版下载到一个自包含环境中。',
